...
class MenuViewTests(TestCase):
    def setUp(self):
        ...
        Dish.objects.create(name="Test Appetizer", description="A test appetizer.", price=5.00, category="Appetizer")
        Dish.objects.create(name="Test Main Course", description="A test main course.", price=15.00, category="Main Course")
        Dish.objects.create(name="Test Dessert", description="A test dessert.", price=7.00, category="Dessert")
    ...
    def test_menu_view_context(self):
        # Test that the menu view passes the correct categories of dishes to the template's context
        response = self.client.get(reverse('menu'))
